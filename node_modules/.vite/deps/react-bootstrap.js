...
var FormLabel = React64.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime59.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var Switch = React68.forwardRef((props, ref) => (0, import_jsx_runtime63.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var RTGTransition = React78.forwardRef((_ref, ref) => {
  let {
...
var Modal = (0, import_react62.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime75.jsx)("div", Object.assign({}, dialogProps, {
    children: React80.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime75.jsx)(import_jsx_runtime76.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime77.jsxs)(import_jsx_runtime76.Fragment, {
...
var ModalBody = React81.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React82.createContext({
...
var ModalDialog = React83.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React84.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React85.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var ModalHeader = React86.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React87.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React88.forwardRef(({
  ...
  const renderBackdrop = (0, import_react64.useCallback)((backdropProps) => (0, import_jsx_runtime85.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React89.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React90.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React91.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React92.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React93.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React94.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React95.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React96.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime93.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React96.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React97.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React98.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React99.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react70.useCallback)((backdropProps) => (0, import_jsx_runtime96.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React100.forwardRef((props, ref) => {
...
var NavbarText = React101.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React102.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React103.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React104.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React105.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React106.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React111.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime113.jsxs)(import_jsx_runtime112.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react77.cloneElement)(children, triggerProps), (0, import_jsx_runtime111.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React112.forwardRef(({
    children,
    ...props
...
var Ratio = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime120.jsx)("div", {
    ...
    children: React117.Children.only(children)
  });
});
...
var SplitButton = React120.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime124.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime123.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime123.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime123.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
    ...
    return (0, import_jsx_runtime126.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime126.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime126.jsx)(Transition2, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime126.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime128.jsx)(Tabs_default, {
  ...props,
  ...
  return (0, import_jsx_runtime130.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime130.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime130.jsx)(Transition2, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime130.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React127.forwardRef(({
  ...
  const table = (0, import_jsx_runtime131.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime132.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime132.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime133.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime132.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime132.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime132.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React129.forwardRef((props, ref) => (0, import_jsx_runtime134.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React131.forwardRef(({
  ...
  return (0, import_jsx_runtime136.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames87.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime135.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var Toast = React133.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime138.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime138.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime138.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
